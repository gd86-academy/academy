# **학원 그룹웨어 프로젝트 📚**  
## 개요
- **Spring Boot**기반으로 **MySQL**과 **MyBatis**를 활용하여 제작한 학원 그룹웨어 시스템입니다.
- 강의 관리, 근태 관리, 결재 관리 기능을 중심으로 시스템을 개발하였으며, 사용자 경험을 향상시키고, 업무 프로세스를 효율적으로 관리할 수 있는 다양한 기능을 제공하고자 노력하였습니다. 🎯
- 2024/01/02부터 2024/02/11까지 해당 프로젝트를 진행하였습니다.
