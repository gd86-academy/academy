...
public class CompleteApprovalRestController {
	...
	@Autowired delLectureApprovalService delLectureApprovalService; // 추후 파일 변경후 수정
	...
	public List<Object[]> completeLectureApprovalList(Integer employeeNo){
		List<LectureApprovalListDTO> completeLectureApprovalList = delLectureApprovalService.getCompleteLectureApprovalList(employeeNo);
		List<Object[]> result = new ArrayList<>();
